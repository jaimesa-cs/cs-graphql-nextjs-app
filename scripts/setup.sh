...
SCHEMA_DIR="../src/graphql/cs"
OUTPUT_PATH="../src/generated"
GQLSCHEMA_FILENAME="$SCHEMA_DIR/cs.gqlschema"
...
if [ ! -f "$GQLSCHEMA_FILENAME" ] ; then
    ...
    run_quicktype \
        --graphql-introspect "http://localhost:3000/api/schema" \
...
run_quicktype --lang "typescript" -o "$OUTPUT_PATH/schema.ts" "$SCHEMA_DIR"